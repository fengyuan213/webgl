...
function _WXReadBinFileSync(filePath) {
 return window.WXWASMSDK.WXReadFileSync(_WXPointer_stringify_adaptor(filePath));
}

function _WXReadFile(filePath, encoding, callbackId) {
 window.WXWASMSDK.WXReadFile(_WXPointer_stringify_adaptor(filePath), _WXPointer_stringify_adaptor(encoding), _WXPointer_stringify_adaptor(callbackId));
}

function _WXReadFileSync(filePath, encoding) {
...
var asmLibraryArg = {
 ...
 "WXReadBinFileSync": _WXReadBinFileSync,
